...
sqlstr = 'CREATE TABLE IF NOT EXISTS TablePM25("no"INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE,"SiteName" TEXT NOT NULL ,"PM25" INTEGER,"county" TEXT NOT NULL)'
...
if(len(html) == 70):
    ...
    if new_md5 != old_md5:
        ...
        for site in jsondata:
            ...
            cursor.execute(
                "INSERT INTO TablePM25 values({},'{}',{},'{}')".format(n, SiteName, PM25, county))
            n += 1
        conn.commit()
        print("=================="+needcounty + "=====================")
